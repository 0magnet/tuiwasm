...
# The demo table is generated too. Order does not matter: the rewrite above
# keeps everything before "## Dependency Graph", and the demo table is above
# that, so it survives either way.
go run ./cmd/gendemos
